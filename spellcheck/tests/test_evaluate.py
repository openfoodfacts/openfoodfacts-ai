...
@pytest.mark.parametrize(
    ...
    [
        (
            ([1, 2, 3, 4, 5, 6, 7], [1, 5, 2, 3, 4, 7]),
            [(1, 1), (None, 5), (2, 2), (3, 3), (4, 4), (5, None), (6, None), (7, 7)],
        ),
        (
            ([1, 2, 3], [7, 8, 9, 1, 2, 4, 5, 3]),
            [
                (None, 7),
                (None, 8),
                (None, 9),
...
@pytest.mark.parametrize(
    ...
    [
        (
            ([(1, 1), (2, 2), (None, 3), (4, 4)], [(1, 1), (2, 2), (4, 4)]),
            (
                [(1, 1), (2, 2), (None, 3), (4, 4)],
        ...
        (
            ([(1, 1), (2, 2), (4, 4)], [(1, 1), (2, 2), (None, 3), (4, 4)]),
            (
                [(1, 1), (2, 2), (None, None), (4, 4)],
                [(1, 1), (2, 2), (None, 3), (4, 4)],
            ),
        ...
        (
            ([(1, 1), (None, 7), (2, 2), (4, 4)], [(1, 1), (2, 2), (None, 3), (4, 4)]),
            (
...
def test_align_pairs(inputs, expected):
    ...
    aligned_pairs1, aligned_pairs2 = evaluator.align_pairs(
        pairs1, pairs2, neutral_pair=(None, None)
    )
...
@pytest.mark.parametrize(
    "inputs, expected",
    [
        (([(1, 1), (2, 3), (4, 5), (6, 6)], [(1, 1), (2, 2), (4, 7), (6, 6)]), [0]),
        (
            (
        ...
        (
            ([(1, 1), (2, 3), (5, 6), (7, 8)], [(1, 1), (2, 4), (5, 6), (7, 9)]),
            [0, 1, 0],
        ),
        (
            (
