...
* Don't modify the last punctation of the list;
...
###List of ingredients:
GauftcŒeza.fÉ$&ig.e.b- Ingré lents : farin de blé, Comté AOP (lait) 3 ,5%, sirop de glucose, beurre pâtissier 13%, poudre de lait entier, oeufs entiers, sel, fibre de blé, poivre de Madagascar. Fabriqué dans un atelier qui utilise des fruits à coque.

###Corrected list of ingredients:
Ingrédients : farine de blé, Comté AOP (lait) 3 ,5%, sirop de glucose, beurre pâtissier 13%, poudre de lait entier, oeufs entiers, sel, fibre de blé, poivre de Madagascar. Fabriqué dans un atelier qui utilise des fruits à coque.
