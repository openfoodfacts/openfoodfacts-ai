...
class SpellcheckExtractionFromArgillaPipeline(metaflow.FlowSpec):
    ...
    deploy_to_hf = metaflow.Parameter(
        ...
        required=False,
        default=False,
        help="Wether to push to dataset to HuggingFace."
    )
    ...
    additional_commit_info = metaflow.Parameter(
        ...
        required=False,
        default="",
        help="Wether to add a commit description to the commit."
    )
    ...
    def extract_from_argilla(self):
        ...
        """
        LOGGER.info("Start extraction from Argilla.")
        ...
        LOGGER.info(f"Extracted dataset: {argilla_dataset}")
        LOGGER.info(f"Save dataset in parquet format at: {self.argilla_dataset_local_path}")
    ...
    def push_to_hf(self):
        ...
        if self.deploy_to_hf:
            LOGGER.info(f"Start deploying to HuggingFace. \
            ...
            LOGGER.info(f"No deployment to HF. Condition is {self.deploy_to_hf}")
