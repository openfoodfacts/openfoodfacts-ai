...
full_database = pd.read_csv(
    r"C:\Users\Antoine\Coding Bootcamp\machine learning\
Open Food Facts\data\en.openfoodfacts.org.products.csv",
    low_memory=False,
    sep="\t",
...
pred1 = pd.read_json(
    r"C:\Users\Antoine\Coding Bootcamp\machine learning\Open Food Facts\robotoff_predictions\dump_page1_by_100000.json"
)
pred2 = pd.read_json(
    r"C:\Users\Antoine\Coding Bootcamp\machine learning\Open Food Facts\robotoff_predictions\dump_page2_by_100000.json"
)
pred3 = pd.read_json(
    r"C:\Users\Antoine\Coding Bootcamp\machine learning\Open Food Facts\robotoff_predictions\dump_page3_by_100000.json"
)
pred4 = pd.read_json(
    r"C:\Users\Antoine\Coding Bootcamp\machine learning\Open Food Facts\robotoff_predictions\dump_page4_by_100000.json"
)
pred5 = pd.read_json(
    r"C:\Users\Antoine\Coding Bootcamp\machine learning\Open Food Facts\robotoff_predictions\dump_page5_by_100000.json"
)
pred6 = pd.read_json(
    r"C:\Users\Antoine\Coding Bootcamp\machine learning\Open Food Facts\robotoff_predictions\dump_page6_by_100000.json"
)
pred7 = pd.read_json(
    r"C:\Users\Antoine\Coding Bootcamp\machine learning\Open Food Facts\robotoff_predictions\dump_page7_by_100000.json"
)
pred8 = pd.read_json(
    r"C:\Users\Antoine\Coding Bootcamp\machine learning\Open Food Facts\robotoff_predictions\dump_page8_by_100000.json"
)
...
predictions.rename(
    columns={colname: "robotoff_" + colname for colname in predictions.columns},
    inplace=True,
)
...
df_with_cats = df_with_predictions.dropna(
    subset=[
        "categories",
        "categories_tags",
        "categories_en",
...
df_with_cats["nb_cats_tags"] = df_with_cats.apply(
    lambda x: len(x["categories_tags"].split(",")), axis=1
)
# We split rows with multiple tags and create a new col "single tag"
single_category_tag = (
    df_with_cats["categories_tags"].str.split(",").apply(pd.Series, 1).stack()
)
...
df_with_predictions.to_csv(
    r"C:\Users\Antoine\Coding Bootcamp\machine learning\
Open Food Facts\data\merged_predictions_off_full.csv",
    index=False,
    header=True,
)
...
df_with_cats.to_csv(
    r"C:\Users\Antoine\Coding Bootcamp\machine learning\
Open Food Facts\data\merged_predictions_off_with_categories.csv",
    index=False,
    header=True,
)
# Only products with categories columns empty
df_without_cats.to_csv(
    r"C:\Users\Antoine\Coding Bootcamp\machine learning\
Open Food Facts\data\merged_predictions_off_without_categories.csv",
    index=False,
    header=True,
)
